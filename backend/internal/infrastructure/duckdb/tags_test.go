...
// through the repository, exactly as the interfaces layer would (after its
// own domainevent.NewEvent signature check).
func signAndSave(t *testing.T, ctx context.Context, repo *Repository, sk string, ev *nostr.Event) {
	t.Helper()
